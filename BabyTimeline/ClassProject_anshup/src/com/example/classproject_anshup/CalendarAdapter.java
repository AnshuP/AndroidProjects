...
public class CalendarAdapter extends BaseAdapter {
    ...
    public View getView(int position, View convertView, ViewGroup parent) {
        ...
        {
        	for (String evDate : items)
        	{
        		String[] eventDate = evDate.split("/");
        		Log.v(TAG,"Item month="+eventDate[0]+" Cal month="+monthStr+" Res= "+eventDate[0].equals(monthStr));
        		Log.v(TAG,"Item day="+eventDate[1]+" Cal day="+date+" Res = "+eventDate[1].equals(date));
        		if(eventDate[0].equals(monthStr) && eventDate[1].equals(date))
        		{Log.v(TAG,"Set ICON**************");
